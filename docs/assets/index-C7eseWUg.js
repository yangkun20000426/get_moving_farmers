...
`)+`
`+p);const T=x+m+o,y=x+p+a,L=Qf(s,s.VERTEX_SHADER,T),w=Qf(s,s.FRAGMENT_SHADER,y);s.attachShader(M,L),s.attachShader(M,w),t.index0AttributeName!==void 0?s.bindAttribLocation(M,0,t.index0AttributeName):t.morphTargets===!0&&s.bindAttribLocation(M,0,"position"),s.linkProgram(M);function U(N){if(n.debug.checkShaderErrors){const G=s.getProgramInfoLog(M)||"",te=s.getShaderInfoLog(L)||"",re=s.getShaderInfoLog(w)||"",H=G.trim(),Z=te.trim(),W=re.trim();let V=!0,B=!0;if(s.getProgramParameter(M,s.LINK_STATUS)===!1)if(V=!1,typeof n.debug.onShaderError=="function")n.debug.onShaderError(s,M,L,w);else{const Me=th(s,L,"vertex"),j=th(s,w,"fragment");ut("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(M,s.VALIDATE_STATUS)+`
